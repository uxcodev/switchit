<template>
  <div class="import-wrapper">
    <div class="content-area">
      ...
      <div v-if="newTable">
        <ImportedPeople :table="newTable"></ImportedPeople>
      </div>
    </div>
...
import FieldMap from './ImportPeople_Import_Map.vue'
import ImportedPeople from './ImportPeople_Import_Results.vue';
...
export default {
  components: { FieldMap, ImportedPeople, LoaderAni },
  data() {
    return {
      names: [],
      isDragOver: false,
