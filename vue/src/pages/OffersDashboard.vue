<template>
 ...
 -->
      <div class="mt8 table-titlebar">
        <h1 class="table-titlebar-title">Your offers</h1>
      ...
      <div class="table">
        <div class="table-header">
          ...
          <div class="table-header-content">
            ...
            <div class="table-header-content-sm">Won</div>
            <div class="table-header-content-sm">Lost</div>
            <div class="table-header-content-sm">Pending</div>
        ...
        <div class="table-rows">
          <div v-for="(offer, index) in offers" :key="index" class="table-row">
            ...
            <div @click="console.log('openOffer()')" class="table-row-content">
              ...
              <div class="access_icons table-row-content-med">
