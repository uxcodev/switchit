<template>
  ...
  <div class="main">
    <div class="container">
      <!--  <div class="ph_pills mb10">
                                                <div v-for="i in 4" :key='i' class="ph_pill"><span :class='i'></span></div>
                                              </div> -->
      <FilterGroup />
      <section>
        <h1>Stats</h1>
...
// import fake_leads from "@/api/fake_data";
...
export default {
  ...
  async mounted() {
    ...
    this.leads = await this.$api.getLeads({ limit: 10, skip: 0 })
    // this.$store.dispatch('openMenu')
    // console.log(api)
    // let response
    // console.log('random api calls:')
    // response = await api.whateverApiCall('get', 'identifiertypes')
    // console.log(response)
    // response = await api.whateverApiCall('get', 'filesourcetypes')
    // console.log(response)
    // response = await api.whateverApiCall('get', 'householdroletypes')
    // console.log(response)
    // response = await api.whateverApiCall('get', 'psd2Institutions')
    // console.log(response)
    // let institutions = await api.getPsd2Institutions()
    // console.log(institutions)

    // get fake data from helper script
    // this.leads = await fake_leads.getLeads()
    // console.log(this.leads)

    // add fake data to database
    // let response = await this.$api.createLeads(this.leads)
